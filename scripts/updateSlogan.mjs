...
async function main() {
  ...
  console.log('Hero section attuale:', JSON.stringify(sections[heroIndex].subtitle, null, 2))

  // Aggiorna il subtitle/slogan
  const updatedSections = [...sections]
  updatedSections[heroIndex] = {
    ...sections[heroIndex],
    subtitle: {
      _type: 'localeString',
      it: 'Soluzioni meccaniche per l\'eccellenza industriale.',
      en: 'Mechanical solutions for industrial excellence.',
      es: 'Soluciones mecánicas para la excelencia industrial.'
    }
  }
  ...
  console.log('\nRisultato:', patchData.results?.[0]?.operation || 'error')
  console.log('Nuovo slogan: "Soluzioni meccaniche per l\'eccellenza industriale."')
}
