// Script per aggiornare la pagina "Chi Siamo" via REST API
// Esegui con: node scripts/updateChiSiamoAPI.js
...
async function updateChiSiamo() {
  console.log('Aggiornamento pagina "Chi Siamo" in corso...');
  ...
  if (response.ok) {
    ...
    console.log('  Frontend: https://glositaly.vercel.app/chi-siamo');
  } else {
